...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | --------------- | ----------------------------------------- |
| 2   | - Learn the importance of OS patching for security strategy and compliance <br> - Understand the blue/green deployment methodology for AMI creation and replacement <br> - Study patching automation using AWS services: <br>&emsp; + EC2 Image Builder (AMI creation) <br>&emsp; + Systems Manager Automation Document (orchestration) <br>&emsp; + CloudFormation with AutoScalingReplacingUpdate policy (graceful deployment) | 06/22/2026 | 06/22/2026      |
