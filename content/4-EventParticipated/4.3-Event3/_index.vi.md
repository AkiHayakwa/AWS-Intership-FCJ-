...
#### Hệ thống NIDS dựa trên Machine Learning
- **Sự cần thiết:** Các quy tắc truyền thống của WAF không đủ để chống lại các cuộc tấn công Zero-day hoặc hành vi bất thường.
- **Cơ chế:** Sử dụng Machine Learning (như thuật toán LightGBM) để học từ dữ liệu mạng thực tế (bộ dữ liệu CSE-CIC-IDS2018) nhằm phát hiện mối đe dọa.
- **Hệ sinh thái:** Kết hợp AWS WAF với các dịch vụ như Lambda, S3, và GuardDuty để tạo lá chắn bảo mật chủ động.
